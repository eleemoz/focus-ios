...
struct UIConstants {
    ...
    struct strings {
        ...
        static let photosPermissionTitle = String(format: NSLocalizedString("photosPermission.title", value: "“%@” Would Like to Access Your Photos", comment: "Dialog title used for requesting a user to enable access to Photos. Placeholder is either Firefox Focus or Firefox Klar"), AppInfo.productName)
